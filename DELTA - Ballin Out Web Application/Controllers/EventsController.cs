...
namespace DELTA___Ballin_Out_Web_Application.Controllers
{
    public class EventsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,EventName,EventImage,EventLocation,EventDescription,EventDate")] Events events)
        {
            if (id != events.Id)
            {
                return NotFound();
